...
def save_o3d_visualization_offscreen(element, save_path):
    """
    Save the open3d drawing to an image file without displaying a window.
    ...
    for geom in element:
        renderer.scene.add_geometry("geometry", geom, o3d.visualization.rendering.MaterialRecord())
