...
class BaseDataset(Dataset):
    ...
    def __init__(self, params, visualize, train=True):
        ...
        for i, scenario_folder in enumerate(scenario_folders):
            ...
            for j, cav_id in enumerate(cav_list):
                ...
                self.scenario_database[i][cav_id]["scenario_id"] = (
                    scenario_folder.split("/")[-1]
                )
    ...
    def retrieve_base_data(self, idx, cur_ego_pose_flag=True):
        ...
        timestamp_id = int(timestamp_key)
        ...
        for cav_id, cav_content in scenario_database.items():
            ...
            # read lidar data and transform to numpy array
            data[cav_id]["lidar_np"] = pcd_utils.pcd_to_np(
                cav_content[timestamp_key_delay]["lidar"]
            )
            data[cav_id]["scenario_id"] = cav_content["scenario_id"]
            data[cav_id]["timestamp_index"] = timestamp_index
            data[cav_id]["timestamp_id"] = timestamp_id
        return data
